...
//--------------------------------------------------------------
CinderCEFRenderHandler::CinderCEFRenderHandler(){
    transparent_ = true;
    initialized = false;
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::init(void){
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::reshape(int w_, int h_){
    w = w_;
    h = h_;
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::OnPopupShow(CefRefPtr<CefBrowser> browser,
                                      bool show) {
    if (!show) {
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::OnPopupSize(CefRefPtr<CefBrowser> browser,
                                      const CefRect& rect) {
...
//--------------------------------------------------------------
CefRect CinderCEFRenderHandler::GetPopupRectInWebView(const CefRect& original_rect) {
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::ClearPopupRects() {
    popup_rect_.Set(0, 0, 0, 0);
    original_popup_rect_.Set(0, 0, 0, 0);
}

//--------------------------------------------------------------
bool CinderCEFRenderHandler::GetScreenInfo(CefRefPtr<CefBrowser> browser,
...
//--------------------------------------------------------------
bool CinderCEFRenderHandler::GetViewRect(CefRefPtr<CefBrowser> browser, CefRect &rect){
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::render() {
...
//--------------------------------------------------------------
void CinderCEFRenderHandler::OnPaint(CefRefPtr<CefBrowser> browser,
